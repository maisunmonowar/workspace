//============================================================================
// Name        : Green_Percentage_T1.cpp
// Author      : Maisun Monowar
// Version     : 1
// Copyright   : Feel free to use it. Just give credit to the original authors (and me for compiling it)
...
int main( int argc, char** argv )
{
	...
	Mat image,img_hsv, imgThresholded, healthyThreshold;
	int total_pixel = 0;
	int total_green = 0;
	int healthy_green = 0;
